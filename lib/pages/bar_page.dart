                  ...
                  await Navigator.of(context).push(
                    MaterialPageRoute(
                      builder: (context) => const PratoPage(
                          namePage: 'PRATOS REGIONAIS'), // The page you want
                    ),
                  );
                },
                child: SizedBox(
            ...
            GestureDetector(
                onTap: () async {
                  await Navigator.of(context).push(
                    MaterialPageRoute(
                      builder: (context) => const PratoPage(
                          namePage: 'PRATOS Executivos'), // The page you want
                    ),
                  );
                },
                child: SizedBox(
            ...
            GestureDetector(
                onTap: () async {
                  await Navigator.of(context).push(
                    MaterialPageRoute(
                      builder: (context) => const PratoPage(
                          namePage: 'Porções'), // The page you want
                    ),
                  );
                },
                child: SizedBox(
            ...
            GestureDetector(
                onTap: () async {
                  await Navigator.of(context).push(
                    MaterialPageRoute(
                      builder: (context) => const PratoPage(
                          namePage: 'Peixes'), // The page you want
                    ),
                  );
                },
                child: SizedBox(
            ...
            GestureDetector(
                onTap: () async {
                  await Navigator.of(context).push(
                    MaterialPageRoute(
                      builder: (context) => const PratoPage(
                          namePage: 'Bebidas'), // The page you want
                    ),
                  );
                },
                child: SizedBox(
